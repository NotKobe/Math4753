#' mymlNorm
#'
#' @param x a vector, your trials
#' @param mu an integer, your mean
#' @param sig an integer, your sd
#' @param ...
#'
#' @return a graph which will show max likelyhood estimates of population mean and sd
#' @export
#'
#' @examples mymlnorm=function(x = data,mu = 4,sig = 2,...)
